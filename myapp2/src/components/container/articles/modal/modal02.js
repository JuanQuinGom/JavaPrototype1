...
import logoModal from '../../../img/cake.png';

export default function Modal02(){
	return(

		<div className="portfolio-modal modal fade" id="portfolioModal2" tabindex="-1" role="dialog" aria-labelledby="portfolioModal1Label" aria-hidden="true">
