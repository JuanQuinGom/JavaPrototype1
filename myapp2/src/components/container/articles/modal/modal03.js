...
import logoModal from '../../../img/circus.png';

export default function Modal03(){
	return(

		<div className="portfolio-modal modal fade" id="portfolioModal3" tabindex="-1" role="dialog" aria-labelledby="portfolioModal1Label" aria-hidden="true">
